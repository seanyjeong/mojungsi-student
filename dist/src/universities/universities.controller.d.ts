...
export declare class UniversitiesController {
    ...
    count(yearId?: string): Promise<{
        universities: number;
        departments: number;
    }>;
    findDepartments(yearId?: string, univId?: string, mojipgun?: 'ga' | 'na' | 'da', region?: string): Promise<({
        universities: {
            univ_id: number;
            univ_name: string;
            short_name: string | null;
    ...
    findDepartmentById(id: number): Promise<{
        universities: {
            univ_id: number;
            univ_name: string;
            short_name: string | null;
